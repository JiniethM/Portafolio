      ...
      <div className="app-content">
        ...
        <header className="header">
          ...
          >
            ...
            ¡Hola, soy Jeyling Jinieth Montiel Jiron!
          </motion.h1>
          ...
          <motion.p
            ...
            custom={0.5}
          >
            Desarrollador Fullstack | React · React Native  · Java
          </motion.p>
        </header>
        ...
        <main className="container">
          ...
          >
            ...
            <p>
              Estudiante de Ingeniería en Sistemas de la Información en la UNAN, nivel de inglés B2,
          ...
          >
            ...
            <ul className="contact-list">
              <li>
                <FaEnvelope /> 
                <a href="mailto:montieljironj@gmail.com">montieljironj@gmail.com</a>
              </li>
              <li>
                <FaGithub /> 
                <a href="https://github.com/JiniethM" target="_blank" rel="noopener noreferrer">GitHub</a>
              </li>
              <li>
                <FaFacebook /> 
                <a href="https://www.facebook.com/jinieth.montiel" target="_blank" rel="noopener noreferrer">Facebook</a>
              </li>
              <li>
                <FaWhatsapp /> 
                <a href="https://wa.me/50582211526?text=Hola%20Jeyling%20Jinieth%20Montiel%20Jiron%20estoy%20interesado%20en%20su%20portafolio." target="_blank" rel="noopener noreferrer">WhatsApp</a>
              </li>
              <li>
                <FaLinkedin /> 
                <a href="https://www.linkedin.com/in/jinieth-montiel/" target="_blank" rel="noopener noreferrer">LinkedIn</a>
              </li>
            </ul>
          </motion.section>
        </main>
        ...
        <footer className="footer">
          <div className="container">
            <p>&copy; 2025 Jeyling Jinieth Montiel Jiron. Todos los derechos reservados.</p>
          </div>
        </footer>
      </div>
    </>
